...
public class CourseService {
    ...
    public EnrollmentResponseDto enrollStudent(Long courseId, Long studentId) {
        ...
        if (course.getPrerequisiteCourseId() != null) {
            boolean hasPrerequisite = enrollmentRepository.existsByCourseIdAndStudentId(
                    course.getPrerequisiteCourseId(), studentId);
            if (!hasPrerequisite) {
                throw new PrerequisiteNotSatisfiedException(studentId, course.getPrerequisiteCourseId());
            }
        }
